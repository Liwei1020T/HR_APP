  ...
  return (
    <div className="bg-white rounded-md shadow-sm border border-gray-100 overflow-hidden">
      <div className="p-4 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
        ...
        <span className={`px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded-full border ${(feedback as any).is_vendor_related ? 'bg-blue-50 text-[#1a4f9c] border-blue-200' : 'bg-gray-50 text-gray-500 border-gray-200'
          }`}>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-bold text-gray-900">{formatVendorStatus((feedback as any).vendor_status)}</span>
        </div>
        ...
        {!(feedback as any).vendor_status || (feedback as any).vendor_status === 'NONE' ? null : (
          <Link
            ...
            className="flex items-center justify-center gap-2 w-full px-3 py-2 bg-blue-50 text-[#1a4f9c] text-sm font-bold rounded-lg hover:bg-blue-100 transition-colors"
          >
            ...
            {userRole === 'SUPERADMIN' ? (
              ...
              !showApprovalOptions ? (
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full px-3 py-2 bg-purple-50 text-purple-700 text-sm font-bold rounded-lg hover:bg-purple-100 transition-colors"
                >
                  <AlertCircle className="h-4 w-4" />
                  Superadmin Approval
                </button>
              ) : (
                <div className="space-y-3 animate-in slide-in-from-top-2 bg-gray-50 p-3 rounded-md border border-gray-100">
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-3 py-2 bg-emerald-600 text-white text-sm font-bold rounded-lg hover:bg-emerald-700 transition-colors shadow-sm disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      disabled={approveVendorMutation?.isPending}
                      className="flex items-center justify-center gap-2 px-3 py-2 bg-white border border-red-200 text-red-600 text-sm font-bold rounded-lg hover:bg-red-50 transition-colors disabled:opacity-50"
                    >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full px-3 py-2 bg-purple-50 text-purple-700 text-sm font-bold rounded-lg hover:bg-purple-100 transition-colors disabled:opacity-50"
              >
                <AlertCircle className="h-4 w-4" />
        ...
        {isHr && (
          <div className="space-y-3 pt-2 border-t border-gray-100">
            <button
              ...
              disabled={!canForward}
              className="w-full px-3 py-2 bg-white border border-gray-300 text-gray-700 text-sm font-bold rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {showVendorForm && (
              <div className="space-y-3 animate-in slide-in-from-top-2">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-gray-600">Due in (days)</label>
                  <input
                    type="number"
                    min={1}
                    value={vendorDueDays}
                ...
                <button
                  ...
                  className="w-full px-3 py-2 bg-[#1a4f9c] text-white text-sm font-bold rounded-lg hover:bg-[#1a4f9c] disabled:opacity-50"
                >
